            ...
            <div class="card w3-border-orange">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <a href="https://imjo.in/jp2wXk">
                            <input type="radio" style="pointer-events:none;"> Individual / 1 year / Rs.500
                          </a> <br><br>
                        
                          <a href="https://theainet.net/register">
                            <input type="radio" style="pointer-events:none;"> Individual / 3 year/ Rs.1200
                          </a><br><br>
                    </form>
                </div>
            </div>
